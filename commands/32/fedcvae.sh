...
do
    echo "Start (K=100)...!"
    {
        ...
        python3 main.py \
        --exp_name "CIFAR10_FedCVAE_$s (K=100; patho=2)" --seed $s --device cuda:0 \
        --dataset CIFAR10 \
        ...
        python3 main.py \
        --exp_name "SVHN_FedCVAE_$s (K=100; patho=2)" --seed $s --device cuda:1 \
        --dataset SVHN \
        --split_type patho --mincls 2 --test_size 0.2 --spc 10 \
        --model_name CVAE --hidden_size 64 --resize 32 \
        --algorithm fedcvae --eval_fraction 1 --eval_type both --eval_every 10 --eval_metrics acc1 fid \
        ...
        python3 main.py \
        --exp_name "MNIST_FedCVAE_$s (K=100; patho=2)" --seed $s --device cuda:2 \
        --dataset MNIST \
        --split_type patho --mincls 2 --test_size 0.2 --spc 10 \
        --model_name CVAE --hidden_size 64 --resize 32 \
        --algorithm fedcvae --eval_fraction 1 --eval_type both --eval_every 10 --eval_metrics acc1 fid \
    ...
    echo "Start (K=10)...!"
    {
        ...
        python3 main.py \
        --exp_name "CIFAR10_FedCVAE_$s (K=10; patho=2)" --seed $s --device cuda:0 \
        --dataset CIFAR10 \
        --split_type patho --mincls 2 --test_size 0.2 --spc 10 \
        --model_name CVAE --hidden_size 64 --resize 32 \
        --algorithm fedcvae --eval_fraction 1 --eval_type both --eval_every 10 --eval_metrics acc1 fid \
        ...
        python3 main.py \
        --exp_name "SVHN_FedCVAE_$s (K=10; patho=2)" --seed $s --device cuda:1 \
        --dataset SVHN \
        --split_type patho --mincls 2 --test_size 0.2 --spc 10 \
        --model_name CVAE --hidden_size 64 --resize 32 \
        --algorithm fedcvae --eval_fraction 1 --eval_type both --eval_every 10 --eval_metrics acc1 fid \
        ...
        python3 main.py \
        --exp_name "MNIST_FedCVAE_$s (K=10; patho=2)" --seed $s --device cuda:2 \
        --dataset MNIST \
        --split_type patho --mincls 2 --test_size 0.2 --spc 10 \
        --model_name CVAE --hidden_size 64 --resize 32 \
        --algorithm fedcvae --eval_fraction 1 --eval_type both --eval_every 10 --eval_metrics acc1 fid \

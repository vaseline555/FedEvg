...
do
    ...
    do
        echo "Start (K=$k; seed=$s)...!"
        {
            ...
            python3 main.py \
            --exp_name "CIFAR10_FedCGAN_$s (K=$k; patho=5)" --seed $s --device cuda:0 \
            --dataset CIFAR10 \
            ...
            python3 main.py \
            --exp_name "CINIC10_FedCGAN_$s (K=$k; patho=5)" --seed $s --device cuda:1 \
            --dataset CINIC10 \
            --split_type patho --mincls 5 --test_size 0.2 --spc 10 \
            --model_name ACGAN --hidden_size 64 --resize 32 \
            --algorithm fedcgan --eval_fraction 1 --eval_type both --eval_every $k --eval_metrics acc1 fid \
            ...
            python3 main.py \
            --exp_name "MNIST_FedCGAN_$s (K=$k; patho=5)" --seed $s --device cuda:2 \
            --dataset MNIST \
            --split_type patho --mincls 5 --test_size 0.2 --spc 10 \
            --model_name ACGAN --hidden_size 64 --resize 32 \
            --algorithm fedcgan --eval_fraction 1 --eval_type both --eval_every $k --eval_metrics acc1 fid \

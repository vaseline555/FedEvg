...
do
    ...
    {
        python3 main.py \
        --exp_name "CIFAR10_FedEvg_$s (K=100; iid)" --seed $s --device cuda:0 \
        --dataset CIFAR10 \
        ...
        python3 main.py \
        --exp_name "SVHN_FedEvg_$s (K=100; iid)" --seed $s --device cuda:1 \
        --dataset SVHN \
        --split_type iid --test_size 0.2 --spc 10 --bpr 10 \
        --model_name ResNet10 --hidden_size 64 --resize 32 --penult_spectral_norm \
        --algorithm fedevg --eval_fraction 1 --eval_type both --eval_every 10 --eval_metrics acc1 fid \
        ...
        python3 main.py \
        --exp_name "MNIST_FedEvg_$s (K=100; iid)" --seed $s --device cuda:2 \
        --dataset MNIST \
        --split_type iid --test_size 0.2 --spc 10 --bpr 10 \
        --model_name ResNet10 --hidden_size 64 --resize 32 --penult_spectral_norm \
        --algorithm fedevg --eval_fraction 1 --eval_type both --eval_every 10 --eval_metrics acc1 fid \
    ...
    {
        python3 main.py \
        --exp_name "CIFAR10_FedEvg_$s (K=10; iid)" --seed $s --device cuda:0 \
        --dataset CIFAR10 \
        --split_type iid --test_size 0.2 --spc 10 --bpr 10 \
        --model_name ResNet10 --hidden_size 64 --resize 32 --penult_spectral_norm \
        --algorithm fedevg --eval_fraction 1 --eval_type both --eval_every 10 --eval_metrics acc1 fid \
        ...
        python3 main.py \
        --exp_name "SVHN_FedEvg_$s (K=10; iid)" --seed $s --device cuda:1 \
        --dataset SVHN \
        --split_type iid --test_size 0.2 --spc 10 --bpr 10 \
        --model_name ResNet10 --hidden_size 64 --resize 32 --penult_spectral_norm \
        --algorithm fedevg --eval_fraction 1 --eval_type both --eval_every 10 --eval_metrics acc1 fid \
        ...
        python3 main.py \
        --exp_name "MNIST_FedEvg_$s (K=10; iid)" --seed $s --device cuda:2 \
        --dataset MNIST \
        --split_type iid --test_size 0.2 --spc 10 --bpr 10 \
        --model_name ResNet10 --hidden_size 64 --resize 32 --penult_spectral_norm \
        --algorithm fedevg --eval_fraction 1 --eval_type both --eval_every 10 --eval_metrics acc1 fid \

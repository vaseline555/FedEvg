...
{
python3 main.py \
--exp_name "CIFAR10_FedEvg_1 (K=100; alpha=0.01)" --seed 1 --device cuda:2 \
--dataset CIFAR10 \
...
python3 main.py \
--exp_name "SVHN_FedEvg_1 (K=100; alpha=0.01)" --seed 1 --device cuda:1 \
--dataset SVHN \
--split_type patho --mincls 2 --test_size 0.2 --spc 10 \
--model_name ResNet10 --hidden_size 64 --resize 32 \
--algorithm fedevg --eval_fraction 1 --eval_type both --eval_every 10 --eval_metrics acc1 fid \
...
python3 main.py \
--exp_name "FashionMNIST_FedEvg_1 (K=100; alpha=0.01)" --seed 1 --device cuda:0 \
